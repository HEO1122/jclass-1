	...
	public Test01() {
		...
		while(itor.hasNext()) {
			...
			if(o instanceof String) {
				...
				double num = (double) o; // Unboxxing이 자동처리...
	...
	public void keyNval() {
		...
		while(itor.hasNext()) {
			...
			/*
				...
				따라서 ent안에 기억되 키값과 벨류(데이터)를 함수를 호출해서 꺼내면 된다.
			 */
