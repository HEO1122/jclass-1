...
public class Test06 {
	...
	public Test06() {
		...
		// 이 배열을 정상적으로 사용할려면 각방에 네모의 인스턴스를 기억시켜줘야 한다.
//		System.out.println("첫번째 네모의 가로 : " + nemo[0].garo); //   아직 배열의 방에 데이터가 결정이 되지 않아서 에러발생
		...
		*/
		...
		System.out.println("첫번째 네모의 가로 : " + nemo[0].garo);
