...
/*
	이 클래스는 MyFrame 객체의 change 버튼이 클릭이 되었을 때 
	이벤트를 처리해주기 위한 클래스
	...
	따라서 다른 클래스에서는 MyFrame의 객체의 주소를 알아내는 방법은 거의 어렵고
	그러면 자기자신은 자신의 주소를 알려줄 수는 있을 것이다.
	따라서 이 클래스가 객체가 되는 순간
	MyFrame의 객체의 주소를 받아서 기억하고 있으면 되나다.
 ...
 */
	...
	public void actionPerformed(ActionEvent e) {
		/*
			...
			결과적으로 버튼이 클릭이 될때 창의 내용이 변경이 될 것이다.
			
			우리는 버튼이 클릭이 될 때
			창의 배경색을 랜덤하게 변경시켜줄려고 한다.
			
			색상은 Color 라는 클래스가 있고
			...
			입력되는 숫자를 랜덤하게 만들어주기만 하면 될것이다.
			칼라 코드는 0 ~ 255 까지의 정수를 사용한다.
		 */
		// 각 칼라 코드 만들고
		...
		// 만들어진 칼라를 MyFrame의 멤버중 pan 에 적용시킨다.
